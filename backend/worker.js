  ...
  async fetch(request, env) {
    ...
    try {
      ...
      if (url.pathname === '/api/stats' && request.method === 'POST') {
        ...
        // Validate payload
        const { player1_address, player2_address, player1_score, player2_score, session_seed } = data;
        ...
        await client.batch([
          ...
          {
            sql: `INSERT INTO players (kaspa_address, total_kills, total_deaths, games_played, wins, losses)
                  VALUES (?, ?, ?, 1, ?, ?)
